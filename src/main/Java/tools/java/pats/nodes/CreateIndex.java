 ...
 */
@ThreadSafe
public class CreateIndex extends Node implements Serializable {

    private static final long serialVersionUID = 1951L;

    private static String INVALID_CREATEINDEX_CMD = "CreateIndex cmd can not be an empty value";
    private static String INVALID_CREATEINDEX_DATA = "CreateIndex data can not be an empty value";
